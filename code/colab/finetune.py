...
chexpert_hub_path = ' /ubc/cs/research/shield/projects/payamfz/medical-ai-research-foundations/orig-models/medical-ai-research-foundations-a-repository-of-medical-foundation-models-1.0.0/cxr-152x2-remedis-m' #@param
...
fname = Path("..", "..", "out", "finetune_res.png")
plt.savefig(fname)